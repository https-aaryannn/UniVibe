...
export default function App() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Optional: uncomment below to restrict to a specific college domain
      // if (!userEmail.endsWith("@yourcollege.edu")) {
      //   await signOut(auth);
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 bg-white hover:bg-zinc-50 border border-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:border-zinc-700 text-zinc-900 dark:text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-3 shadow-sm"
        >
